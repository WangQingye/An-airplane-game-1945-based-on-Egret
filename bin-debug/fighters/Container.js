...
(function (fighter) {
    //主游戏容器
    var GameCotainer = (function (_super) {
        __extends(GameCotainer, _super);
        function GameCotainer() {
            _super.call(this);
        ...
        var d = __define,c=GameCotainer,p=c.prototype;
    ...
    fighter.GameCotainer = GameCotainer;
    egret.registerClass(GameCotainer,'fighter.GameCotainer');
})(fighter || (fighter = {}));
